...
CREATE TABLE IF NOT EXISTS user (
    ...
    cutucadasRestantes INT NOT NULL DEFAULT 20,
    lastCutucadaReset DATETIME DEFAULT NULL,
    lastCutucadaGeral DATETIME DEFAULT NULL,
    createdat TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    lastaccess TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    consentVersion INT NOT NULL DEFAULT 0,
...
-- ==========================
-- TABELAS DE CUTUCADAS
-- ==========================
CREATE TABLE IF NOT EXISTS cutucadas (
    id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    senderUserId INT UNSIGNED NOT NULL,
    targetUserId INT UNSIGNED,
    message VARCHAR(255),
